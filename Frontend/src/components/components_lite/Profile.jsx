...
// const skills =["React","Javascript","Html","CSS","Python","Node.js","MYSQL","Redux","TailwindCSS",
//     "Docker","Kubernetes"];
...
const Profile = () => { 
 ...
 {user?.profile?.skills.length !== 0 ? (
                user?.profile?.skills.map((item, index) => (
                  <Badge key={index} className="bg-black text-white  px-2 py-1 rounded  hover:bg-gray-900" >{item}</Badge>
                ))
              ) : (
                <span>NA</span>
              )}
